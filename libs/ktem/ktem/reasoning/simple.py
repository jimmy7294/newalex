...
class AddQueryContextPipeline(BaseComponent):
    ...
    def run(self, question: str, history: list) -> Document:
        messages = [
            ...
            HumanMessage(content="How to get a fishing license?"),
            AIMessage(
                content="As a legislative chatbot, please provide detailed guidance on how to obtain a fishing license. Include the legal requirements, the issuing authority, associated costs, and any specific regulations or restrictions related to fishing licenses in Åland. Also, clarify if there are exemptions or special licenses for different groups, such as seniors or veterans"
            ),
            HumanMessage(content="What is the speed limit for passenger cars?"),
            AIMessage(content="Vad är gällande lag angående hastigheten i trafiken på Ålands?"),
        ]
